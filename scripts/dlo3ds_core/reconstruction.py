...
class SplineReconstruction(object):
    ...
    def splinesDiscriminator(self, points_ref, splines, splines_evs = False, positive = True, debug = False):      
        # if positive = True then spline_ref[i][0] - spline_ev[i][0] should be positive
