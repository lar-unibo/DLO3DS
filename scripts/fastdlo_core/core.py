...
from fastdlo_core.siam_net.nn_predict import NN
from fastdlo_core.seg_net.predict import SegNet

from fastdlo_core.siam_net.nn_dataset import AriadnePredictData
from fastdlo_core.proc.labelling import LabelsPred
import fastdlo_core.proc.utils as utils
...
class Pipeline():
    ...
    def run(self, source_img, mask_th = 127):
        ...
        return self.process(source_img=source_img, mask_img=mask_img, mask_th=mask_th)
